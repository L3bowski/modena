const { configureWinston } = require('./winston-config');
const tracer = require('./tracer');
const express = require('express');
const server = express();
const { join } = require('path');
const { configurePassport } = require('./passport');
const { discoverApps } = require('./app-discovery');
const { getAppResolverMiddleware } = require('./app-resolver');
const { registerApps } = require('./app-register');
